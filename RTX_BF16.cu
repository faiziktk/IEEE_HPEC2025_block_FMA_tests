...
void printBHalfIEEE(nv_bfloat16 h) {
    ...
    std::cout << "IEEE 754 Brain-Float Representation:\n";
    std::cout << "Binary    : " << binary << "\n";
    std::cout << "Sign      : " << binary[15] << "\n";
    std::cout << "Exponent  : " << binary.to_string().substr(1, 8) << "\n";
    std::cout << "Fraction  : " << binary.to_string().substr(9, 7) << "\n";
}
...
int main(int argc, char** argv) {
    ...
    int pout = 24, pin = 8;
    nv_bfloat16* h_a, * h_b, * d16_a, * d16_b;
    float* d_c, * h_c;
    ...
    * ------------------------------------------------------------
    ...
    h_a[0] = __float2bfloat16(ldexp(1, (-pout + j)));
    h_b[0] = __float2bfloat16(1);
    h_a[1] = __float2bfloat16(ldexp(1, (-pout + j)));
    h_b[1] = __float2bfloat16(1);
    h_c[0] = pow(2, j);
    ...
    h_a[1] = __float2bfloat16(ldexp(1, (-pout + j)));
    h_b[1] = __float2bfloat16(ldexp(1, -1));
    h_a[2] = __float2bfloat16(ldexp(1, (-pout + j)));
    h_b[2] = __float2bfloat16(ldexp(1, -1));
    ...
    * ------------------------------------------------------------
    ...
    host_reset(h_a, h_b, h_c);
    h_a[0] = __float2bfloat16(ldexp(1, -pout + t) + ldexp(1, -pout));
    h_a[1] = __float2bfloat16(ldexp(1, -pout + t) + ldexp(1, -pout));
    h_b[0] = __float2bfloat16(1);
    h_b[1] = __float2bfloat16(1);
    ...
    * ------------------------------------------------------------
    ...
    h_c_temp = h_c[0];
    h_a[0] = __float2bfloat16(ldexp(1, j));
    h_a[1] = h_a[0];
    h_a[2] = h_a[0];
    h_b[0] = __float2bfloat16(1);
    ...
    * ------------------------------------------------------------
    ...
    h_a[0] = __float2bfloat16(ldexp(1, -pout + j));
    h_a[1] = h_a[0];
    h_b[0] = __float2bfloat16(ldexp(1, -neab) + ldexp(1, -neab - 1));
    h_b[1] = h_b[0];
    wmma_init_run(h_a, h_b, h_c, d16_a, d16_b, d_c, false);
    h_c_pos = h_c[0];
    ...
    * ------------------------------------------------------------
    ...
    h_c[0] = 1 + ldexp(1, -pout + 1);
    h_a[NFMA] = __float2bfloat16(ldexp(1, -pout));
    h_b[NFMA] = __float2bfloat16(ldexp(1, 0) + ldexp(1, -1));
    wmma_init_run(h_a, h_b, h_c, d16_a, d16_b, d_c, false);
    h_c_pos = h_c[0];
    ...
    h_b[0] = __float2bfloat16(ldexp(1, -neab) + ldexp(1, -neab - 1));
    h_b[1] = __float2bfloat16(ldexp(1, -neab) + ldexp(1, -neab - 1));
    wmma_init_run(h_a, h_b, h_c, d16_a, d16_b, d_c, false);
    h_c_pos = h_c[0];
